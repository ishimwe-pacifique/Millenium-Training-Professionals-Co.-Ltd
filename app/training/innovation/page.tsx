...
import { CheckCircle, Lightbulb, Rocket, Puzzle } from "lucide-react"
...
export default function InnovationPage() {
  ...
  const benefits = [
    { icon: Lightbulb, title: "Creative Thinking", description: "Develop innovative problem-solving approaches" },
    { icon: Rocket, title: "Innovation Strategy", description: "Build systematic innovation processes" },
    { icon: Puzzle, title: "Design Thinking", description: "Human-centered design methodologies" }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Unlock your creative potential and drive innovation in your organization through proven methodologies. 
                Learn to foster a culture of innovation and creative problem-solving.
              </p>
            ...
            <div className="relative h-96 rounded-xl overflow-hidden" style={{ backgroundColor: `${PRIMARY_COLOR}20` }}>
              <img
                src="/images/innovation-training.jpg"
